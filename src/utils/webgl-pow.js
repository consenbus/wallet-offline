// consenbus-webgl-pow
// consenbus Currency Proof of Work Value generation using WebGL2
// Author:  numtel <ben@latenightsketches.com>
// License: MIT

// window.ConsenbusWebglPow(hashHex, callback, progressCallback);
...
(function() {
  ...
  function calculate(hashHex, callback, progressCallback) {
    ...
    canvas.width = window.ConsenbusWebglPow.width;
    canvas.height = window.ConsenbusWebglPow.height;
    ...
    void main() {
      ...
      if((BLAKE2B_IV32_1 ^ v[1] ^ v[17]) > 0xFFFFC000u) {
